...
echo "13. INSTALL PANEL (ONLY PANEL)"
echo "14. INSTALL WINGS (ONLY WINGS)"
...
echo "22. INSTALL TEMA FUTURISTIC THEME"
echo "23. INSTALL TEMA NIGHTCORE"
echo "24. AUTO INSTALL PANEL & WINGS"
echo "25. KELUAR DARI INSTALLER"
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
read -p "PILIH OPSI (1-25): " OPTION
case "$OPTION" in
    1)
...
if [[ "$HAS_PTERODACTYL" == "YES" || "$HAS_PTERODACTYL" == "yes" ]]; then
  ...
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
read -p "Masukkan Nama Buat Panel Anda " nama
read -p "Masukkan/Buat Password Anda " pw
read -p "Masukkan Subdomain " subdo
